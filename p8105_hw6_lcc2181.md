...
Drawing 5,000 bootstrap samples, and for each bootstrap sample,
producing estimates of R-squared and log(beta0 \* beta1)
...
The distributions of R-squared and log(beta0 \*beta1) both appear to be
relatively normally distributed, although both are slightly left-tailed.

The following code chunk identifies 2.5% and 97.5% quantiles for
R-squared and log(beta0 \* beta1):
...
Based on this output, the 95% CIs for R-squared and log(beta0 \* beta1)
are:
